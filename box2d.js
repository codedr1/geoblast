...
b2Settings.b2_angularSleepTolerance = 2 / 180;
b2Settings.b2Assert = function(b) {
    b || (void 0).x++
};
var b2Vec2 = function(b, c) {
        if (arguments.length == 2) {
            this.x = b;
            this.y = c
        }
    };
b2Vec2.Make = function(b, c) {
    return new b2Vec2(b, c)
};
a = b2Vec2.prototype;
a.x = 0;
a.y = 0;
...
a.MulTM = function(b) {
    var c = b2Math.b2Dot(this, b.col1);
...
a = b2Manifold.prototype;
a.__constructor = function() {
    this.points = new Array(b2Settings.b2_maxManifoldPoints);
    for (var b = 0; b < b2Settings.b2_maxManifoldPoints; b++) this.points[b] = new b2ManifoldPoint;
...
a.pointCount = 0;
a.Reset = function() {
    for (var b = 0; b < b2Settings.b2_maxManifoldPoints; b++) this.points[b].Reset();
    this.normal.SetZero();
    this.pointCount = 0
};
a.Set = function(b) {
    this.pointCount = b.pointCount;
    for (var c = 0; c < b2Settings.b2_maxManifoldPoints; c++) this.points[c].Set(b.points[c]);
...
b2BoundaryListener.prototype.Violation = function() {};
var b2MassData = function() {
        this.__varz();
        this.__constructor.apply(this, arguments)
    };
a = b2MassData.prototype;
a.__constructor = function() {};
a.__varz = function() {
...
b2Collision.ClipSegmentToLine = function(b, c, d, e) {
    var f, g = 0;
    f = c[0];
    var h = f.v;
    f = c[1];
    var i = f.v,
        j = b2Math.b2Dot(d, h) - e;
    f = b2Math.b2Dot(d, i) - e;
    if (j <= 0) b[g++] = c[0];
    if (f <= 0) b[g++] = c[1];
    if (j * f < 0) {
        d = j / (j - f);
...
b2Collision.EdgeSeparation = function(b, c, d, e, f) {
    var g = b.m_vertices;
    b = b.m_normals;
    var h = e.m_vertexCount,
        i = e.m_vertices,
        j, k;
    j = c.R;
    k = b[d];
...
b2Collision.FindMaxSeparation = function(b, c, d, e, f) {
    var g = c.m_vertexCount,
        h = c.m_normals,
        i, j;
    j = f.R;
    i = e.m_centroid;
    var k = f.position.x + (j.col1.x * i.x + j.col2.x * i.y),
        l = f.position.y + (j.col1.y * i.x + j.col2.y * i.y);
    j = d.R;
    i = c.m_centroid;
    ...
    h = b2Collision.EdgeSeparation(c, d, k, e, f);
    if (h > 0) return h;
    l = k - 1 >= 0 ? k - 1 : g - 1;
    m = b2Collision.EdgeSeparation(c, d, l, e, f);
    if (m > 0) return m;
    n = k + 1 < g ? k + 1 : 0;
    var o = b2Collision.EdgeSeparation(c, d, n, e, f);
    if (o > 0) return o;
    j = i = 0;
    if (m > h && m > o) {
        j = -1;
...
b2Collision.FindIncidentEdge = function(b, c, d, e, f, g) {
    var h = c.m_normals,
        i = f.m_vertexCount;
    c = f.m_vertices;
    f = f.m_normals;
...
b2Collision.b2CollidePolygons = function(b, c, d, e, f) {
    var g = b.pointCount = 0,
        h = [g],
        i = b2Collision.FindMaxSeparation(h, c, d, e, f);
    g = h[0];
    if (!(i > 0)) {
        var j = 0;
        h = [j];
        var k = b2Collision.FindMaxSeparation(h, e, f, c, d);
        j = h[0];
        if (!(k > 0)) {
            var l = new b2XForm,
                m = new b2XForm,
            ...
            b2Collision.FindIncidentEdge(c, i, l, n, e, m);
            g = i.m_vertexCount;
            m = i.m_vertices;
            i = m[n];
            e = i.Copy();
            ...
            b2Math.SubtractVV(i, e);
            g = b2Math.b2MulMV(l.R, b2Math.SubtractVV(i, e));
            g.Normalize();
            n = b2Math.b2CrossVF(g, 1);
            e = b2Math.b2MulX(l, e);
            i = b2Math.b2MulX(l, i);
            l = b2Math.b2Dot(n, e);
            m = -b2Math.b2Dot(g, e);
            ...
            k = 0;
            k = b2Collision.ClipSegmentToLine(j, c, g.Negative(), m);
            if (!(k < 2)) {
                k = b2Collision.ClipSegmentToLine(e, j, g, i);
                if (!(k < 2)) {
                    b.normal = h ? n.Negative() : n.Copy();
                    for (m = g = 0; m < b2Settings.b2_maxManifoldPoints; ++m) {
                        c = e[m];
                        i = b2Math.b2Dot(n, c.v) - l;
                        if (i <= 0) {
                            j = b.points[g];
                            j.separation = i;
                            j.localPoint1 = b2Math.b2MulXT(d, c.v);
                            j.localPoint2 = b2Math.b2MulXT(f, c.v);
                            j.id.key = c.id._key;
...
b2Collision.b2CollideCircles = function(b, c, d, e, f) {
    b.pointCount = 0;
    var g, h;
    g = d.R;
    h = c.m_localPosition;
    var i = d.position.x + (g.col1.x * h.x + g.col2.x * h.y),
        j = d.position.y + (g.col1.y * h.x + g.col2.y * h.y);
    g = f.R;
    h = e.m_localPosition;
...
b2Collision.b2CollidePolygonAndCircle = function(b, c, d, e, f) {
    b.pointCount = 0;
    var g, h, i, j, k, l;
    l = f.R;
    k = e.m_localPosition;
...
b2Collision.b2TestOverlap = function(b, c) {
    var d = c.lowerBound,
        e = b.upperBound,
        f = d.x - e.x,
        g = d.y - e.y;
...
b2PairCallback.prototype.PairAdded = function() {
    return null
};
b2PairCallback.prototype.PairRemoved = function() {};
var b2JointDef = function() {
        this.__varz();
        this.__constructor.apply(this, arguments)
    };
a = b2JointDef.prototype;
a.__constructor = function() {
...
a = b2Color.prototype;
a.__constructor = function(b, c, d) {
    this._r = parseInt(255 * b2Math.b2Clamp(b, 0, 1));
    this._g = parseInt(255 * b2Math.b2Clamp(c, 0, 1));
    this._b = parseInt(255 * b2Math.b2Clamp(d, 0, 1))
};
a.__varz = function() {};
a._r = 0;
a._g = 0;
...
a.set = function(b) {
    this._g = parseInt(255 * b2Math.b2Clamp(b, 0, 1))
};
a.set = function(b) {
    this._b = parseInt(255 * b2Math.b2Clamp(b, 0, 1))
};
a.get = function() {
...
b2PairManager.prototype.__constructor = function() {
    ...
    for (b = 0; b < b2Pair.b2_tableCapacity; ++b) this.m_hashTable[b] = b2Pair.b2_nullPair;
    this.m_pairs = new Array(b2Settings.b2_maxPairs);
    for (b = 0; b < b2Settings.b2_maxPairs; ++b) this.m_pairs[b] = new b2Pair;
    this.m_pairBuffer = new Array(b2Settings.b2_maxPairs);
    for (b = 0; b < b2Settings.b2_maxPairs; ++b) this.m_pairBuffer[b] = new b2BufferedPair;
    for (b = 0; b < b2Settings.b2_maxPairs; ++b) {
        this.m_pairs[b].proxyId1 = b2Pair.b2_nullProxy;
        this.m_pairs[b].proxyId2 = b2Pair.b2_nullProxy;
...
b2PairManager.Hash = function(b, c) {
    b = c << 16 & 4294901760 | b;
    b = ~b + (b << 15 & 4294934528);
    b ^= b >> 12 & 1048575;
    b += b << 2 & 4294967292;
...
b2PairManager.EqualsPair = function(b, c) {
    return b.proxyId1 == c.proxyId1 && b.proxyId2 == c.proxyId2
};
a = b2PairManager.prototype;
a.m_broadPhase = null;
a.m_callback = null;
a.m_pairs = null;
a.m_freePair = 0;
...
a.RemovePair = function(b, c) {
    ...
    d = b2PairManager.Hash(b, c) & b2Pair.b2_tableMask;
    for (var e = this.m_hashTable[d], f = null; e != b2Pair.b2_nullPair;) if (b2PairManager.Equals(this.m_pairs[e], b, c)) {
        b = e;
        c = this.m_pairs[e];
        if (f) f.next = c.next;
...
a.FindHash = function(b, c, d) {
    ...
    for (d = this.m_pairs[e]; e != b2Pair.b2_nullPair && b2PairManager.Equals(d, b, c) == false;) {
        e = d.next;
        d = this.m_pairs[e]
    }
    if (e == b2Pair.b2_nullPair) return null;
    return d
};
...
a.__constructor = function(b, c, d, e) {
    ...
    for (b = 0; b < this.m_constraintCount; b++) this.m_constraints[b] = new b2ContactConstraint;
    for (b = e = 0; b < d; ++b) {
        f = c[b];
        var h = f.m_shape1.m_body,
            i = f.m_shape2.m_body,
            j = f.m_manifoldCount,
            k = f.GetManifolds(),
            l = f.m_friction;
        ...
        for (var m = h.m_linearVelocity.x, n = h.m_linearVelocity.y, o = i.m_linearVelocity.x, q = i.m_linearVelocity.y, r = h.m_angularVelocity, s = i.m_angularVelocity, v = 0; v < j; ++v) {
            ...
            for (var A = 0; A < w.pointCount; ++A) {
                ...
                var B;
                g = h.m_xf.R;
                var C = u.localPoint1.x - h.m_sweep.localCenter.x,
                    E = u.localPoint1.y - h.m_sweep.localCenter.y;
                ...
                if (C < -b2Settings.b2_velocityThreshold) x.velocityBias += -w.restitution * C
            }++e
        }
    }
};
    ...
    for (var c = 0; c < this.m_constraintCount; ++c) {
        ...
        if (b.warmStarting) {
            ...
            for (n = 0; n < o; ++n) {
                ...
                var r = q.normalImpulse * k + q.tangentImpulse * l,
                    s = q.normalImpulse * l + q.tangentImpulse * m;
...
a.SolveVelocityConstraints = function() {
    for (var b = 0, c, d, e, f, g, h, i = 0; i < this.m_constraintCount; ++i) {
        var j = this.m_constraints[i],
            k = j.body1,
            l = j.body2,
            m = k.m_angularVelocity,
            n = l.m_angularVelocity,
            o = k.m_linearVelocity,
        ...
        for (b = 0; b < u; ++b) {
            ...
            d = d * t + e * w;
            e = c.tangentMass * -d;
            d = b2Math.b2Max(c.normalImpulse + f, 0);
            f = d - c.normalImpulse;
            g = A * c.normalImpulse;
            g = b2Math.b2Clamp(c.tangentImpulse + e, -g, g);
...
a.SolvePositionConstraints = function(b) {
    for (var c = 0, d, e, f = 0; f < this.m_constraintCount; ++f) for (var g = this.m_constraints[f], h = g.body1, i = g.body2, j = h.m_sweep.c, k = h.m_sweep.a, l = i.m_sweep.c, m = i.m_sweep.a, n = h.m_mass * h.m_invMass, o = h.m_mass * h.m_invI, q = i.m_mass * i.m_invMass, r = i.m_mass * i.m_invI, s = g.normal.x, v = g.normal.y, z = g.pointCount, y = 0; y < z; ++y) {
        ...
        var w = t.localAnchor1.x - e.x,
            A = t.localAnchor1.y - e.y;
        ...
        c = b2Math.b2Min(c, d);
        d = b * b2Math.b2Clamp(d + b2Settings.b2_linearSlop, -b2Settings.b2_maxLinearCorrection, 0);
        d = -t.equalizedMass * d;
        x = t.positionImpulse;
        t.positionImpulse = b2Math.b2Max(x + d, 0);
    ...
    return c >= -1.5 * b2Settings.b2_linearSlop
};
...
a = b2ContactConstraintPoint.prototype;
a.__constructor = function() {};
a.__varz = function() {
...
a.localAnchor1 = new b2Vec2;
a.localAnchor2 = new b2Vec2;
a.r1 = new b2Vec2;
a.r2 = new b2Vec2;
...
b2DestructionListener.prototype.SayGoodbyeJoint = function() {};
b2DestructionListener.prototype.SayGoodbyeShape = function() {};
...
a.groundAnchor1 = new b2Vec2;
a.groundAnchor2 = new b2Vec2;
a.localAnchor1 = new b2Vec2;
a.localAnchor2 = new b2Vec2;
a.length1 = null;
a.maxLength1 = null;
...
a.Initialize = function(b, c, d, e, f, g, h) {
    ...
    this.maxLength1 = h - this.ratio * b2PulleyJoint.b2_minPulleyLength;
    this.maxLength2 = (h - b2PulleyJoint.b2_minPulleyLength) / this.ratio
};
var b2Jacobian = function() {
        this.__varz();
        this.__constructor.apply(this, arguments)
    };
a = b2Jacobian.prototype;
a.__constructor = function() {};
a.__varz = function() {
    this.linear1 = new b2Vec2;
    this.linear2 = new b2Vec2
};
a.linear1 = new b2Vec2;
a.angular1 = null;
a.linear2 = new b2Vec2;
a.angular2 = null;
a.SetZero = function() {
...
b2DebugDraw.e_coreShapeBit = 4;
b2DebugDraw.e_aabbBit = 8;
b2DebugDraw.e_obbBit = 16;
b2DebugDraw.e_pairBit = 32;
b2DebugDraw.e_centerOfMassBit = 64;
a = b2DebugDraw.prototype;
a.m_drawFlags = 0;
a.m_sprite = null;
a.m_drawScale = 1;
a.m_lineThickness = 1;
...
a.DrawPolygon = function(b, c, d) {
    this.m_sprite.graphics.lineStyle(this.m_lineThickness, d.color, this.m_alpha);
...
a.DrawSolidPolygon = function(b, c, d) {
    this.m_sprite.graphics.lineStyle(this.m_lineThickness, d.color, this.m_alpha);
    this.m_sprite.graphics.moveTo(b[0].x * this.m_drawScale, b[0].y * this.m_drawScale);
    this.m_sprite.graphics.beginFill(d.color, this.m_fillAlpha);
    for (d = 1; d < c; d++) this.m_sprite.graphics.lineTo(b[d].x * this.m_drawScale, b[d].y * this.m_drawScale);
    this.m_sprite.graphics.lineTo(b[0].x * this.m_drawScale, b[0].y * this.m_drawScale);
...
a.DrawSolidCircle = function(b, c, d, e) {
    this.m_sprite.graphics.lineStyle(this.m_lineThickness, e.color, this.m_alpha);
    this.m_sprite.graphics.moveTo(0, 0);
    this.m_sprite.graphics.beginFill(e.color, this.m_fillAlpha);
    this.m_sprite.graphics.drawCircle(b.x * this.m_drawScale, b.y * this.m_drawScale, c * this.m_drawScale);
    this.m_sprite.graphics.endFill();
...
a = b2ContactConstraint.prototype;
a.__constructor = function() {
    this.points = new Array(b2Settings.b2_maxManifoldPoints);
    for (var b = 0; b < b2Settings.b2_maxManifoldPoints; b++) this.points[b] = new b2ContactConstraintPoint
};
a.__varz = function() {
    this.normal = new b2Vec2
};
...
b2Distance.ProcessTwo = function(b, c, d, e, f) {
    var g = f[0];
    f = f[1];
    var h = d[0];
    d = d[1];
...
b2Distance.ProcessThree = function(b, c, d, e, f) {
    var g = f[0],
        h = f[1],
        i = f[2];
    f = d[0];
...
b2Distance.InPoints = function(b, c, d) {
    for (var e = 100 * Number.MIN_VALUE, f = 0; f < d; ++f) {
        var g = c[f],
            h = Math.abs(b.x - g.x),
            i = Math.abs(b.y - g.y),
            j = Math.max(Math.abs(b.x), Math.abs(g.x));
        g = Math.max(Math.abs(b.y), Math.abs(g.y));
        if (h < e * (j + 1) && i < e * (g + 1)) return true
    }
    return false
};
b2Distance.DistanceGeneric = function(b, c, d, e, f, g) {
    var h, i = b2Distance.s_p1s,
        j = b2Distance.s_p2s,
        k = b2Distance.s_points,
        l = 0;
    ...
    for (var m = 0, n = 0; n < 20; ++n) {
        ...
        case 1:
            ...
            h.x = s;
            h.y = v;
            l = b2Distance.ProcessTwo(b, c, i, j, k);
            break;
        case 2:
            h = i[2];
            h.SetV(q);
            ...
            h.x = s;
            h.y = v;
            l = b2Distance.ProcessThree(b, c, i, j, k);
            break
        }
        if (l == 3) {
            b2Distance.g_GJK_Iterations = n;
        ...
        for (r = 0; r < l; ++r) {
            h = k[r];
            q = b2Math.b2Max(q, h.x * h.x + h.y * h.y)
        }
...
b2Distance.DistanceCC = function(b, c, d, e, f, g) {
    var h, i;
    h = e.R;
    i = d.m_localPosition;
    ...
    i = g - e;
    var l = h * h + i * i;
    d = d.m_radius - b2Settings.b2_toiSlop;
    f = f.m_radius - b2Settings.b2_toiSlop;
    var m = d + f;
    if (l > m * m) {
        l = Math.sqrt(h * h + i * i);
        h /= l;
...
b2Distance.DistancePC = function(b, c, d, e, f, g) {
    var h, i, j = b2Distance.gPoint;
    i = f.m_localPosition;
    h = g.R;
    j.p.x = g.position.x + (h.col1.x * i.x + h.col2.x * i.y);
    j.p.y = g.position.y + (h.col1.y * i.x + h.col2.y * i.y);
    d = b2Distance.DistanceGeneric(b, c, d, e, j, b2Math.b2XForm_identity);
    f = f.m_radius - b2Settings.b2_toiSlop;
    if (d > f) {
        d -= f;
        e = c.x - b.x;
...
b2Distance.Distance = function(b, c, d, e, f, g) {
    var h = d.m_type,
        i = f.m_type;
    if (h == b2Shape.e_circleShape && i == b2Shape.e_circleShape) return b2Distance.DistanceCC(b, c, d, e, f, g);
    if (h == b2Shape.e_polygonShape && i == b2Shape.e_circleShape) return b2Distance.DistancePC(b, c, d, e, f, g);
    if (h == b2Shape.e_circleShape && i == b2Shape.e_polygonShape) return b2Distance.DistancePC(c, b, f, g, d, e);
    if (h == b2Shape.e_polygonShape && i == b2Shape.e_polygonShape) return b2Distance.DistanceGeneric(b, c, d, e, f, g);
    return 0
};
...
b2Shape.prototype.__constructor = function(b) {
...
b2Shape.Create = function(b) {
    switch (b.type) {
    case b2Shape.e_circleShape:
        return new b2CircleShape(b);
    case b2Shape.e_polygonShape:
        return new b2PolygonShape(b);
    default:
        return null
    }
};
b2Shape.Destroy = function() {};
a = b2Shape.prototype;
a.m_type = 0;
a.m_next = null;
a.m_body = null;
...
a.CreateProxy = function(b, c) {
    var d = b2Shape.s_proxyAABB;
    this.ComputeAABB(d, c);
    this.m_proxyId = b.InRange(d) ? b.CreateProxy(d, this) : b2Pair.b2_nullProxy
};
...
a.Synchronize = function(b, c, d) {
    if (this.m_proxyId == b2Pair.b2_nullProxy) return false;
    var e = b2Shape.s_syncAABB;
...
a = b2DistanceJointDef.prototype;
a._super = function() {
    b2JointDef.prototype.__constructor.apply(this, arguments)
};
a.__constructor = function() {
...
a.R = new b2Mat22;
a.center = new b2Vec2;
a.extents = new b2Vec2;
var b2BodyDef = function() {
        this.__varz();
        this.__constructor.apply(this, arguments)
    };
a = b2BodyDef.prototype;
a.__constructor = function() {
...
a = b2PrismaticJointDef.prototype;
a._super = function() {
    b2JointDef.prototype.__constructor.apply(this, arguments)
};
a.__constructor = function() {
...
a = b2RevoluteJointDef.prototype;
a._super = function() {
    b2JointDef.prototype.__constructor.apply(this, arguments)
};
a.__constructor = function() {
...
a.m_localPosition = new b2Vec2;
a.m_radius = null;
a.TestPoint = function(b, c) {
    var d = b.R,
        e = b.position.x + (d.col1.x * this.m_localPosition.x + d.col2.x * this.m_localPosition.y);
...
a.TestSegment = function(b, c, d, e, f) {
    var g = b.R,
        h = e.p1.x - (b.position.x + (g.col1.x * this.m_localPosition.x + g.col2.x * this.m_localPosition.y));
    ...
    var j = h * g + b * e,
        k = g * g + e * e;
    i = j * j - k * i;
    if (i < 0 || k < Number.MIN_VALUE) return b2Shape.e_missCollide;
    i = -(j + Math.sqrt(i));
    if (0 <= i && i <= f * k) {
        i /= k;
        c[0] = i;
...
a.ComputeAABB = function(b, c) {
    var d = c.R,
        e = c.position.x + (d.col1.x * this.m_localPosition.x + d.col2.x * this.m_localPosition.y);
...
a.ComputeSweptAABB = function(b, c, d) {
    ...
    b.upperBound.Set((f > g ? f : g) + this.m_radius, (c > d ? c : d) + this.m_radius)
};
a.ComputeMass = function(b) {
    b.mass = this.m_density * b2Settings.b2_pi * this.m_radius * this.m_radius;
...
a.UpdateSweepRadius = function(b) {
    ...
    c = Math.sqrt(c * c + b * b);
    this.m_sweepRadius = c + this.m_radius - b2Settings.b2_toiSlop
};
var b2Joint = function() {
        this.__varz();
        this.__constructor.apply(this, arguments)
    };
b2Joint.prototype.__constructor = function(b) {
    this.m_type = b.type;
...
a.m_prev = null;
a.m_next = null;
a.m_node1 = new b2JointEdge;
a.m_node2 = new b2JointEdge;
a.m_body1 = null;
a.m_body2 = null;
a.m_inv_dt = null;
a.m_islandFlag = null;
...
a.m_revolute2 = null;
a.m_prismatic2 = null;
a.m_groundAnchor1 = new b2Vec2;
a.m_groundAnchor2 = new b2Vec2;
a.m_localAnchor1 = new b2Vec2;
a.m_localAnchor2 = new b2Vec2;
a.m_J = new b2Jacobian;
a.m_constant = null;
a.m_ratio = null;
a.m_mass = null;
a.m_force = null;
...
a.GetReactionTorque = function() {
    var b = this.m_body2.m_xf.R,
        c = this.m_localAnchor1.x - this.m_body2.m_sweep.localCenter.x,
        d = this.m_localAnchor1.y - this.m_body2.m_sweep.localCenter.y,
...
a.SolveVelocityConstraints = function(b) {
    var c = this.m_body1,
        d = this.m_body2,
        e = this.m_J.Compute(c.m_linearVelocity, c.m_angularVelocity, d.m_linearVelocity, d.m_angularVelocity);
...
b2BroadPhase.prototype.__constructor = function(b, c) {
    var d = 0;
    this.m_pairManager.Initialize(this, c);
    this.m_worldAABB = b;
    for (d = this.m_proxyCount = 0; d < b2Settings.b2_maxProxies; d++) {
    ...
    for (d = 0; d < 2; d++) {
        ...
        for (c = 0; c < 2 * b2Settings.b2_maxProxies; c++) this.m_bounds[d][c] = new b2Bound
    }
    d = b.upperBound.y - b.lowerBound.y;
    this.m_quantizationFactor.x = b2Settings.USHRT_MAX / (b.upperBound.x - b.lowerBound.x);
    this.m_quantizationFactor.y = b2Settings.USHRT_MAX / d;
    ...
    b = new b2Proxy;
    this.m_proxyPool[parseInt(b2Settings.b2_maxProxies - 1)] = b;
    b.SetNext(b2Pair.b2_nullProxy);
    b.timeStamp = 0;
    b.overlapCount = b2BroadPhase.b2_invalid;
    b.userData = null;
    this.m_freeProxy = 0;
...
a = b2BroadPhase.prototype;
a.m_pairManager = new b2PairManager;
a.m_proxyPool = new Array(b2Settings.b2_maxPairs);
a.m_freeProxy = 0;
a.m_bounds = new Array(2 * b2Settings.b2_maxProxies);
a.m_querySortKeys = new Array(b2Settings.b2_maxProxies);
a.m_queryResults = new Array(b2Settings.b2_maxProxies);
a.m_queryResultCount = 0;
a.m_worldAABB = null;
a.m_quantizationFactor = new b2Vec2;
a.m_proxyCount = 0;
a.m_timeStamp = 0;
a.ComputeBounds = function(b, c, d) {
    var e = d.lowerBound.x,
        f = d.lowerBound.y;
    e = b2Math.b2Min(e, this.m_worldAABB.upperBound.x);
    f = b2Math.b2Min(f, this.m_worldAABB.upperBound.y);
    e = b2Math.b2Max(e, this.m_worldAABB.lowerBound.x);
    f = b2Math.b2Max(f, this.m_worldAABB.lowerBound.y);
    var g = d.upperBound.x;
    d = d.upperBound.y;
    g = b2Math.b2Min(g, this.m_worldAABB.upperBound.x);
    d = b2Math.b2Min(d, this.m_worldAABB.upperBound.y);
    g = b2Math.b2Max(g, this.m_worldAABB.lowerBound.x);
    d = b2Math.b2Max(d, this.m_worldAABB.lowerBound.y);
    b[0] = parseInt(this.m_quantizationFactor.x * (e - this.m_worldAABB.lowerBound.x)) & b2Settings.USHRT_MAX - 1;
    c[0] = parseInt(this.m_quantizationFactor.x * (g - this.m_worldAABB.lowerBound.x)) % 65535 | 1;
    b[1] = parseInt(this.m_quantizationFactor.y * (f - this.m_worldAABB.lowerBound.y)) & b2Settings.USHRT_MAX - 1;
...
a.Query = function(b, c, d, e, f, g, h) {
    d = b2BroadPhase.BinarySearch(f, g, d);
...
a.IncrementTimeStamp = function() {
    if (this.m_timeStamp == b2Settings.USHRT_MAX) {
        for (var b = 0; b < b2Settings.b2_maxProxies; ++b) this.m_proxyPool[b].timeStamp = 0;
        this.m_timeStamp = 1
    }
...
a.InRange = function(b) {
    ...
    c = b2Math.b2Max(c, e);
    d = b2Math.b2Max(d, f);
    return b2Math.b2Max(c, d) < 0
};
a.GetProxy = function(b) {
    var c = this.m_proxyPool[b];
    if (b == b2Pair.b2_nullProxy || c.IsValid() == false) return null;
    return c
};
a.CreateProxy = function(b, c) {
    var d = 0,
...
a.DestroyProxy = function(b) {
    ...
    e.lowerBounds[0] = b2BroadPhase.b2_invalid;
    e.lowerBounds[1] = b2BroadPhase.b2_invalid;
    e.upperBounds[0] = b2BroadPhase.b2_invalid;
    e.upperBounds[1] = b2BroadPhase.b2_invalid;
...
a.MoveProxy = function(b, c) {
    var d, e, f = 0,
        ...
        h;
    d = 0;
    if (!(b == b2Pair.b2_nullProxy || b2Settings.b2_maxProxies <= b)) if (c.IsValid() != false) {
        var i = 2 * this.m_proxyCount,
            j = this.m_proxyPool[b],
            k = new b2BoundValues;
...
a.Validate = function() {
    for (var b = 0; b < 2; ++b) for (var c = this.m_bounds[b], d = 2 * this.m_proxyCount, e = 0, f = 0; f < d; ++f) if (c[f].IsLower() == true) e++;
    else e--
};
a.QuerySegment = function(b, c, d, e) {
    var f = (b.p2.x - b.p1.x) * this.m_quantizationFactor.x,
        g = (b.p2.y - b.p1.y) * this.m_quantizationFactor.y,
        h = f < -Number.MIN_VALUE ? -1 : f > Number.MIN_VALUE ? 1 : 0,
        i = g < -Number.MIN_VALUE ? -1 : g > Number.MIN_VALUE ? 1 : 0,
        j = this.m_quantizationFactor.x * (b.p1.x - this.m_worldAABB.lowerBound.x);
    b = this.m_quantizationFactor.y * (b.p1.y - this.m_worldAABB.lowerBound.y);
    var k = [],
        l = [];
    k[0] = parseInt(j) & b2Settings.USHRT_MAX - 1;
    k[1] = parseInt(b) & b2Settings.USHRT_MAX - 1;
    l[0] = k[0] + 1;
    l[1] = k[1] + 1;
    var m = 0,
        n = 0,
    ...
    if (e != null) {
        ...
        for (k = 0; k < this.m_queryResultCount - 1;) {
            ...
            if (l < 0 ? o >= 0 : l > o && o >= 0) {
                ...
                this.m_queryResults[k + 1] = this.m_queryResults[k];
...
b2TimeOfImpact.TimeOfImpact = function(b, c, d, e) {
    var f, g, h = b.m_sweepRadius,
        i = d.m_sweepRadius,
        j = c.t0,
        k = c.c.x - c.c0.x,
        l = c.c.y - c.c0.y,
        ...
        q = e.a - e.a0,
        r = 0,
        s = b2TimeOfImpact.s_p1,
        v = b2TimeOfImpact.s_p2,
        z = 0,
        y = g = 0,
        t = 0;
    for (f = 0;;) {
        t = (1 - r) * j + r;
        g = b2TimeOfImpact.s_xf1;
        y = b2TimeOfImpact.s_xf2;
        c.GetXForm(g, t);
        e.GetXForm(y, t);
        t = b2Distance.Distance(s, v, b, g, d, y);
        if (z == 0) if (t > 2 * b2Settings.b2_toiSlop) f = 1.5 * b2Settings.b2_toiSlop;
        else {
            f = 0.05 * b2Settings.b2_toiSlop;
            g = t - 0.5 * b2Settings.b2_toiSlop;
            f = f > g ? f : g
        }
        if (t - f < 0.05 * b2Settings.b2_toiSlop || z == 20) break;
        g = v.x - s.x;
        y = v.y - s.y;
...
a.type = b2Shape.e_unknownShape;
a.userData = null;
a.friction = 0.2;
a.restitution = 0;
a.density = 0;
a.isSensor = false;
a.filter = new b2FilterData;
...
b2PolygonDef.prototype._super = function() {
    b2ShapeDef.prototype.__constructor.apply(this, arguments)
};
b2PolygonDef.prototype.__constructor = function() {
    this.type = b2Shape.e_polygonShape;
    for (var b = this.vertexCount = 0; b < b2Settings.b2_maxPolygonVertices; b++) this.vertices[b] = new b2Vec2
};
...
b2PolygonDef.prototype.SetAsBox = function(b, c) {
    this.vertexCount = 4;
...
b2PolygonDef.prototype.SetAsOrientedBox = function(b, c, d, e) {
    this.vertexCount = 4;
    this.vertices[0].Set(-b, -c);
    this.vertices[1].Set(b, -c);
    this.vertices[2].Set(b, c);
...
b2Contact.prototype.__constructor = function(b, c) {
    this.m_flags = 0;
    if (!b || !c) this.m_shape2 = this.m_shape1 = null;
    else {
        if (b.IsSensor() || c.IsSensor()) this.m_flags |= b2Contact.e_nonSolidFlag;
        this.m_shape1 = b;
        this.m_shape2 = c;
...
b2Contact.e_nonSolidFlag = 1;
b2Contact.e_slowFlag = 2;
b2Contact.e_islandFlag = 4;
b2Contact.e_toiFlag = 8;
b2Contact.s_registers = null;
b2Contact.s_initialized = false;
b2Contact.AddType = function(b, c, d, e) {
    b2Contact.s_registers[d][e].createFcn = b;
    b2Contact.s_registers[d][e].destroyFcn = c;
    b2Contact.s_registers[d][e].primary = true;
    if (d != e) {
        b2Contact.s_registers[e][d].createFcn = b;
        b2Contact.s_registers[e][d].destroyFcn = c;
        b2Contact.s_registers[e][d].primary = false
    }
};
b2Contact.InitializeRegisters = function() {
    ...
    for (var b = 0; b < b2Shape.e_shapeTypeCount; b++) {
        ...
        for (var c = 0; c < b2Shape.e_shapeTypeCount; c++) b2Contact.s_registers[b][c] = new b2ContactRegister
    }
...
b2Contact.Create = function(b, c, d) {
    if (b2Contact.s_initialized == false) {
        b2Contact.InitializeRegisters();
        b2Contact.s_initialized = true
    }
    var e = b2Contact.s_registers[b.m_type][c.m_type],
        f = e.createFcn;
...
b2Contact.Destroy = function(b, c) {
    if (b.m_manifoldCount > 0) {
        b.m_shape1.m_body.WakeUp();
        b.m_shape2.m_body.WakeUp()
    }
    var d = b2Contact.s_registers[b.m_shape1.m_type][b.m_shape2.m_type].destroyFcn;
    d(b, c)
};
a = b2Contact.prototype;
a.m_flags = 0;
a.m_prev = null;
a.m_next = null;
a.m_node1 = new b2ContactEdge;
a.m_node2 = new b2ContactEdge;
a.m_shape1 = null;
a.m_shape2 = null;
a.m_manifoldCount = 0;
a.m_friction = null;
...
a.Update = function(b) {
    ...
    if (b.IsStatic() || b.IsBullet() || d.IsStatic() || d.IsBullet()) this.m_flags &= ~b2Contact.e_slowFlag;
    else this.m_flags |= b2Contact.e_slowFlag
};
a.Evaluate = function() {};
...
a.InitVelocityConstraints = function(b) {
    ...
    d > b2Settings.b2_linearSlop ? this.m_u.Multiply(1 / d) : this.m_u.SetZero();
...
a.SolveVelocityConstraints = function() {
    ...
    var h = this.m_localAnchor2.x - d.m_sweep.localCenter.x,
        i = this.m_localAnchor2.y - d.m_sweep.localCenter.y;
...
a.SolvePositionConstraints = function() {
    ...
    var j = d.m_sweep.c.y + i - c.m_sweep.c.y - f;
    b = Math.sqrt(g * g + j * j);
    g /= b;
    j /= b;
    b = b - this.m_length;
    b = b2Math.b2Clamp(b, -b2Settings.b2_maxLinearCorrection, b2Settings.b2_maxLinearCorrection);
    var k = -this.m_mass * b;
    this.m_u.Set(g, j);
    g = k * this.m_u.x;
    j = k * this.m_u.y;
    ...
    return b2Math.b2Abs(b) < b2Settings.b2_linearSlop
};
a.GetAnchor1 = function() {
    return this.m_body1.GetWorldPoint(this.m_localAnchor1)
};
...
b2Body.prototype.__constructor = function(b, c) {
    this.m_flags = 0;
    if (b.isBullet) this.m_flags |= b2Body.e_bulletFlag;
    if (b.fixedRotation) this.m_flags |= b2Body.e_fixedRotationFlag;
    if (b.allowSleep) this.m_flags |= b2Body.e_allowSleepFlag;
    if (b.isSleeping) this.m_flags |= b2Body.e_sleepFlag;
    this.m_world = c;
    ...
    if ((this.m_flags & b2Body.e_fixedRotationFlag) == 0) this.m_I = b.massData.I;
    if (this.m_I > 0) this.m_invI = 1 / this.m_I;
    this.m_type = this.m_invMass == 0 && this.m_invI == 0 ? b2Body.e_staticType : b2Body.e_dynamicType;
    this.m_userData = b.userData;
...
b2Body.e_bulletFlag = 32;
b2Body.e_fixedRotationFlag = 64;
...
a.m_type = 0;
a.m_xf = new b2XForm;
a.m_sweep = new b2Sweep;
a.m_linearVelocity = new b2Vec2;
a.m_angularVelocity = null;
a.m_force = new b2Vec2;
a.m_torque = null;
a.m_world = null;
a.m_prev = null;
a.m_next = null;
...
a.CreateShape = function(b) {
    ...
    b = b2Shape.Create(b, this.m_world.m_blockAllocator);
...
a.DestroyShape = function(b) {
    if (this.m_world.m_lock != true) {
        ...
        b.m_next = null;
        --this.m_shapeCount;
        b2Shape.Destroy(b, this.m_world.m_blockAllocator)
    }
};
a.SetMass = function(b) {
    if (this.m_world.m_lock != true) {
        ...
        this.m_mass = b.mass;
        if (this.m_mass > 0) this.m_invMass = 1 / this.m_mass;
        if ((this.m_flags & b2Body.e_fixedRotationFlag) == 0) this.m_I = b.I;
        if (this.m_I > 0) this.m_invI = 1 / this.m_I;
...
a.SetMassFromShapes = function() {
    var b;
    if (this.m_world.m_lock != true) {
        var c = this.m_invI = this.m_I = this.m_invMass = this.m_mass = 0,
            d = 0,
            e = b2Body.s_massData;
...
a.GetWorldPoint = function(b) {
    var c = this.m_xf.R;
    b = new b2Vec2(c.col1.x * b.x + c.col2.x * b.y, c.col1.y * b.x + c.col2.y * b.y);
    b.x += this.m_xf.position.x;
    b.y += this.m_xf.position.y;
    return b
};
a.GetWorldVector = function(b) {
    return b2Math.b2MulMV(this.m_xf.R, b)
};
a.GetLocalPoint = function(b) {
    return b2Math.b2MulXT(this.m_xf, b)
};
a.GetLocalVector = function(b) {
    return b2Math.b2MulTMV(this.m_xf.R, b)
};
a.GetLinearVelocityFromWorldPoint = function(b) {
    return new b2Vec2(this.m_linearVelocity.x + this.m_angularVelocity * (b.y - this.m_sweep.c.y), this.m_linearVelocity.x - this.m_angularVelocity * (b.x - this.m_sweep.c.x))
};
...
a.SetBullet = function(b) {
    if (b) this.m_flags |= b2Body.e_bulletFlag;
...
a.AllowSleeping = function(b) {
    if (b) this.m_flags |= b2Body.e_allowSleepFlag;
    else {
...
a.IsConnected = function(b) {
    for (var c = this.m_jointList; c; c = c.next) if (c.other == b) return c.joint.m_collideConnected == false;
    return false
};
a.Advance = function(b) {
...
b2ContactFilter.prototype.ShouldCollide = function(b, c) {
    b = b.GetFilterData();
    c = c.GetFilterData();
...
b2ContactFilter.prototype.RayCollide = function(b, c) {
    if (!b) return true;
...
b2PolygonShape.prototype.__constructor = function(b) {
    this._super(b);
    ...
    for (c = 0; c < this.m_vertexCount; ++c) {
        ...
        e = Math.sqrt(f * f + d * d);
        this.m_normals[c] = new b2Vec2(d / e, -f / e)
    }
    this.m_centroid = b2PolygonShape.ComputeCentroid(b.vertices, b.vertexCount);
    ...
    for (c = 0; c < this.m_vertexCount; ++c) {
        ...
        var g = this.m_vertices[c].x - this.m_centroid.x,
            h = this.m_vertices[c].y - this.m_centroid.y,
            i = b * g + f * h - b2Settings.b2_toiSlop;
        g = d * g + e * h - b2Settings.b2_toiSlop;
        h = 1 / (b * e - f * d);
        this.m_coreVertices[c] = new b2Vec2(h * (e * i - f * g) + this.m_centroid.x, h * (b * g - d * i) + this.m_centroid.y)
    }
};
...
b2PolygonShape.ComputeCentroid = function(b, c) {
    for (var d = new b2Vec2, e = 0, f = 1 / 3, g = 0; g < c; ++g) {
        var h = b[g],
            i = g + 1 < c ? b[parseInt(g + 1)] : b[0],
            j = 0.5 * ((h.x - 0) * (i.y - 0) - (h.y - 0) * (i.x - 0));
        e += j;
        d.x += j * f * (0 + h.x + i.x);
        d.y += j * f * (0 + h.y + i.y)
    }
...
b2PolygonShape.ComputeOBB = function(b, c, d) {
    var e = 0,
        f = new Array(b2Settings.b2_maxPolygonVertices + 1);
...
a = b2PolygonShape.prototype;
a.s_supportVec = new b2Vec2;
a.m_centroid = null;
a.m_obb = new b2OBB;
a.m_vertices = new Array(b2Settings.b2_maxPolygonVertices);
a.m_normals = new Array(b2Settings.b2_maxPolygonVertices);
a.m_coreVertices = new Array(b2Settings.b2_maxPolygonVertices);
a.m_vertexCount = 0;
a.TestPoint = function(b, c) {
    var d;
    d = b.R;
...
a.TestSegment = function(b, c, d, e, f) {
    ...
    j = b.R;
    var l = h * j.col1.x + i * j.col1.y,
        m = h * j.col2.x + i * j.col2.y;
    ...
    for (var n = -1, o = 0; o < this.m_vertexCount; ++o) {
        ...
        if (f < g) return b2Shape.e_missCollide
    }
    if (n >= 0) {
        c[0] = g;
        j = b.R;
...
a.ComputeAABB = function(b, c) {
    var d, e, f = b2PolygonShape.s_computeMat;
    d = c.R;
    e = this.m_obb.R.col1;
    ...
    b.upperBound.Set(h + g, c + f)
};
a.ComputeSweptAABB = function(b, c, d) {
    var e = b2PolygonShape.s_sweptAABB1,
        f = b2PolygonShape.s_sweptAABB2;
...
a.ComputeMass = function(b) {
    for (var c = 0, d = 0, e = 0, f = 0, g = 1 / 3, h = 0; h < this.m_vertexCount; ++h) {
        var i = this.m_vertices[h],
            j = h + 1 < this.m_vertexCount ? this.m_vertices[parseInt(h + 1)] : this.m_vertices[0],
            k = i.x - 0,
            l = i.y - 0,
            m = j.x - 0,
            n = j.y - 0,
...
a.GetFirstVertex = function(b) {
    return b2Math.b2MulX(b, this.m_coreVertices[0])
};
a.Centroid = function(b) {
    return b2Math.b2MulX(b, this.m_centroid)
};
...
a.normalImpulse = null;
a.tangentImpulse = null;
a.id = new b2ContactID;
var b2Island = function() {
        this.__varz();
        this.__constructor.apply(this, arguments)
    };
b2Island.prototype.__constructor = function(b, c, d, e, f) {
    var g = 0;
...
a.Solve = function(b, c, d, e) {
    ...
    for (f = 0; f < this.m_bodyCount; ++f) {
        ...
        if (!g.IsStatic()) {
            ...
            g.m_force.SetZero();
            g.m_torque = 0;
            g.m_linearVelocity.Multiply(b2Math.b2Clamp(1 - b.dt * g.m_linearDamping, 0, 1));
            g.m_angularVelocity *= b2Math.b2Clamp(1 - b.dt * g.m_angularDamping, 0, 1);
            if (g.m_linearVelocity.LengthSquared() > b2Settings.b2_maxLinearVelocitySquared) {
                g.m_linearVelocity.Normalize();
                g.m_linearVelocity.x *= b2Settings.b2_maxLinearVelocity;
                g.m_linearVelocity.y *= b2Settings.b2_maxLinearVelocity
            }
            if (g.m_angularVelocity * g.m_angularVelocity > b2Settings.b2_maxAngularVelocitySquared) g.m_angularVelocity = g.m_angularVelocity < 0 ? -b2Settings.b2_maxAngularVelocity : b2Settings.b2_maxAngularVelocity
        }
    }
    c = new b2ContactSolver(b, this.m_contacts, this.m_contactCount, this.m_allocator);
    ...
    if (d) {
        ...
        for (this.m_positionIterationCount = 0; this.m_positionIterationCount < b.maxIterations; ++this.m_positionIterationCount) {
            d = c.SolvePositionConstraints(b2Settings.b2_contactBaumgarte);
            h = true;
            for (f = 0; f < this.m_jointCount; ++f) {
                g = this.m_joints[f];
    ...
    if (e) {
        e = Number.MAX_VALUE;
        c = b2Settings.b2_linearSleepTolerance * b2Settings.b2_linearSleepTolerance;
        d = b2Settings.b2_angularSleepTolerance * b2Settings.b2_angularSleepTolerance;
        for (f = 0; f < this.m_bodyCount; ++f) {
            g = this.m_bodies[f];
            if (g.m_invMass != 0) {
                if ((g.m_flags & b2Body.e_allowSleepFlag) == 0) e = g.m_sleepTime = 0;
                if ((g.m_flags & b2Body.e_allowSleepFlag) == 0 || g.m_angularVelocity * g.m_angularVelocity > d || b2Math.b2Dot(g.m_linearVelocity, g.m_linearVelocity) > c) e = g.m_sleepTime = 0;
                else {
                    g.m_sleepTime += b.dt;
                    e = b2Math.b2Min(e, g.m_sleepTime)
                }
            }
        }
        if (e >= b2Settings.b2_timeToSleep) for (f = 0; f < this.m_bodyCount; ++f) {
            g = this.m_bodies[f];
            g.m_flags |= b2Body.e_sleepFlag;
...
a.SolveTOI = function(b) {
    var c = 0,
        d = new b2ContactSolver(b, this.m_contacts, this.m_contactCount, this.m_allocator);
    ...
    for (c = 0; c < b.maxIterations; ++c) if (d.SolvePositionConstraints(0.75)) break;
...
a.Report = function(b) {
    if (this.m_listener != null) for (var c = 0; c < this.m_contactCount; ++c) {
        var d = this.m_contacts[c],
            e = b[c],
            f = b2Island.s_reportCR;
        f.shape1 = d.m_shape1;
        f.shape2 = d.m_shape2;
        var g = f.shape1.m_body,
            h = d.m_manifoldCount;
        d = d.GetManifolds();
        for (var i = 0; i < h; ++i) {
            var j = d[i];
...
a.localPoint1 = new b2Vec2;
a.localPoint2 = new b2Vec2;
a.separation = null;
a.normalImpulse = null;
a.tangentImpulse = null;
a.id = new b2ContactID;
...
b2Math.b2Mat22_identity = new b2Mat22(0, new b2Vec2(1, 0), new b2Vec2(0, 1));
b2Math.b2XForm_identity = new b2XForm(b2Math.b2Vec2_zero, b2Math.b2Mat22_identity);
b2Math.b2IsValid = function(b) {
    return isFinite(b)
};
b2Math.b2Dot = function(b, c) {
    return b.x * c.x + b.y * c.y
};
b2Math.b2CrossVV = function(b, c) {
    return b.x * c.y - b.y * c.x
};
b2Math.b2CrossVF = function(b, c) {
    return new b2Vec2(c * b.y, -c * b.x)
};
b2Math.b2CrossFV = function(b, c) {
    return new b2Vec2(-b * c.y, b * c.x)
};
b2Math.b2MulMV = function(b, c) {
    return new b2Vec2(b.col1.x * c.x + b.col2.x * c.y, b.col1.y * c.x + b.col2.y * c.y)
};
b2Math.b2MulTMV = function(b, c) {
    return new b2Vec2(b2Math.b2Dot(c, b.col1), b2Math.b2Dot(c, b.col2))
};
b2Math.b2MulX = function(b, c) {
    c = b2Math.b2MulMV(b.R, c);
    c.x += b.position.x;
    c.y += b.position.y;
    return c
};
b2Math.b2MulXT = function(b, c) {
    c = b2Math.SubtractVV(c, b.position);
    var d = c.x * b.R.col1.x + c.y * b.R.col1.y;
    c.y = c.x * b.R.col2.x + c.y * b.R.col2.y;
    c.x = d;
    return c
};
b2Math.AddVV = function(b, c) {
    return new b2Vec2(b.x + c.x, b.y + c.y)
};
b2Math.SubtractVV = function(b, c) {
    return new b2Vec2(b.x - c.x, b.y - c.y)
};
b2Math.b2Distance = function(b, c) {
    var d = b.x - c.x;
    b = b.y - c.y;
    return Math.sqrt(d * d + b * b)
};
b2Math.b2DistanceSquared = function(b, c) {
    var d = b.x - c.x;
    b = b.y - c.y;
    return d * d + b * b
};
b2Math.MulFV = function(b, c) {
    return new b2Vec2(b * c.x, b * c.y)
};
b2Math.AddMM = function(b, c) {
    return new b2Mat22(0, b2Math.AddVV(b.col1, c.col1), b2Math.AddVV(b.col2, c.col2))
};
b2Math.b2MulMM = function(b, c) {
    return new b2Mat22(0, b2Math.b2MulMV(b, c.col1), b2Math.b2MulMV(b, c.col2))
};
b2Math.b2MulTMM = function(b, c) {
    var d = new b2Vec2(b2Math.b2Dot(b.col1, c.col1), b2Math.b2Dot(b.col2, c.col1));
    b = new b2Vec2(b2Math.b2Dot(b.col1, c.col2), b2Math.b2Dot(b.col2, c.col2));
    return new b2Mat22(0, d, b)
};
b2Math.b2Abs = function(b) {
    return b > 0 ? b : -b
};
b2Math.b2AbsV = function(b) {
    return new b2Vec2(b2Math.b2Abs(b.x), b2Math.b2Abs(b.y))
};
b2Math.b2AbsM = function(b) {
    return new b2Mat22(0, b2Math.b2AbsV(b.col1), b2Math.b2AbsV(b.col2))
};
b2Math.b2Min = function(b, c) {
    return b < c ? b : c
};
b2Math.b2MinV = function(b, c) {
    return new b2Vec2(b2Math.b2Min(b.x, c.x), b2Math.b2Min(b.y, c.y))
};
b2Math.b2Max = function(b, c) {
    return b > c ? b : c
};
b2Math.b2MaxV = function(b, c) {
    return new b2Vec2(b2Math.b2Max(b.x, c.x), b2Math.b2Max(b.y, c.y))
};
b2Math.b2Clamp = function(b, c, d) {
    return b2Math.b2Max(c, b2Math.b2Min(b, d))
};
b2Math.b2ClampV = function(b, c, d) {
    return b2Math.b2MaxV(c, b2Math.b2MinV(b, d))
};
b2Math.b2Swap = function(b, c) {
    var d = b[0];
    b[0] = c[0];
    c[0] = d
};
...
b2Math.b2RandomRange = function(b, c) {
    var d = Math.random();
    return d = (c - b) * d + b
};
b2Math.b2NextPowerOfTwo = function(b) {
    b |= b >> 1 & 2147483647;
    b |= b >> 2 & 1073741823;
    b |= b >> 4 & 268435455;
    b |= b >> 8 & 16777215;
...
a.localPosition = new b2Vec2(0, 0);
a.radius = null;
var b2ContactPoint = function() {
        this.__varz();
        this.__constructor.apply(this, arguments)
    };
a = b2ContactPoint.prototype;
a.__constructor = function() {};
a.__varz = function() {
    this.position = new b2Vec2;
...
b2PolygonContact.prototype.__constructor = function(b, c) {
    this._super(b, c);
...
b2PolygonContact.Create = function(b, c) {
    return new b2PolygonContact(b, c)
};
b2PolygonContact.Destroy = function() {};
a = b2PolygonContact.prototype;
a.m0 = new b2Manifold;
a.m_manifolds = [new b2Manifold];
a.m_manifold = null;
a.Evaluate = function(b) {
    var c, d, e, f = this.m_shape1.m_body,
        g = this.m_shape2.m_body,
        h, i = 0;
    this.m0.Set(this.m_manifold);
    b2Collision.b2CollidePolygons(this.m_manifold, this.m_shape1, f.m_xf, this.m_shape2, g.m_xf);
    var j = [false, false];
    h = b2PolygonContact.s_evalCP;
...
a.__constructor = function(b) {
    ...
    var c = this.m_target.x - this.m_body2.m_xf.position.x,
        d = this.m_target.y - this.m_body2.m_xf.position.y,
        e = this.m_body2.m_xf.R;
    ...
    e = 2 * b2Settings.b2_pi * b.frequencyHz;
...
a.K1 = new b2Mat22;
a.K2 = new b2Mat22;
a.m_localAnchor = new b2Vec2;
a.m_target = new b2Vec2;
a.m_impulse = new b2Vec2;
a.m_mass = new b2Mat22;
a.m_C = new b2Vec2;
a.m_maxForce = null;
a.m_beta = null;
a.m_gamma = null;
...
a.InitVelocityConstraints = function(b) {
    var c = this.m_body2,
        d;
    d = c.m_xf.R;
    var e = this.m_localAnchor.x - c.m_sweep.localCenter.x,
...
b2CircleContact.prototype.__constructor = function(b, c) {
    this._super(b, c);
    this.m_manifold = this.m_manifolds[0];
    this.m_manifold.pointCount = 0;
...
b2CircleContact.Create = function(b, c) {
    return new b2CircleContact(b, c)
};
b2CircleContact.Destroy = function() {};
a = b2CircleContact.prototype;
a.m_manifolds = [new b2Manifold];
a.m0 = new b2Manifold;
a.m_manifold = null;
a.Evaluate = function(b) {
    ...
    this.m0.Set(this.m_manifold);
    b2Collision.b2CollideCircles(this.m_manifold, this.m_shape1, c.m_xf, this.m_shape2, d.m_xf);
    var f = b2CircleContact.s_evalCP;
...
b2PulleyJoint.prototype.__constructor = function(b) {
    this._super(b);
    ...
    this.m_maxLength1 = b2Math.b2Min(b.maxLength1, this.m_constant - this.m_ratio * b2PulleyJoint.b2_minPulleyLength);
    this.m_maxLength2 = b2Math.b2Min(b.maxLength2, (this.m_constant - b2PulleyJoint.b2_minPulleyLength) / this.m_ratio);
...
a.GetLength1 = function() {
    var b = this.m_body1.GetWorldPoint(this.m_localAnchor1),
...
a.GetLength2 = function() {
    var b = this.m_body2.GetWorldPoint(this.m_localAnchor2),
...
a.InitVelocityConstraints = function(b) {
    ...
    e = d.m_sweep.c.x + i;
    h = d.m_sweep.c.y + j;
    var k = this.m_ground.m_xf.position.x + this.m_groundAnchor2.x,
    ...
    e = this.m_u1.Length();
    h = this.m_u2.Length();
    e > b2Settings.b2_linearSlop ? this.m_u1.Multiply(1 / e) : this.m_u1.SetZero();
    h > b2Settings.b2_linearSlop ? this.m_u2.Multiply(1 / h) : this.m_u2.SetZero();
...
a.SolveVelocityConstraints = function(b) {
    ...
    if (this.m_state == b2Joint.e_atUpperLimit) {
        ...
        e = this.m_force;
        this.m_force = b2Math.b2Max(0, this.m_force + l);
        l = this.m_force - e;
    ...
    if (this.m_limitState1 == b2Joint.e_atUpperLimit) {
        ...
        this.m_limitForce1 = b2Math.b2Max(0, this.m_limitForce1 + l);
    ...
    if (this.m_limitState2 == b2Joint.e_atUpperLimit) {
        ...
        this.m_limitForce2 = b2Math.b2Max(0, this.m_limitForce2 + l);
...
a.SolvePositionConstraints = function() {
    ...
    if (this.m_state == b2Joint.e_atUpperLimit) {
        ...
        d = this.m_u1.Length();
        m = this.m_u2.Length();
        d > b2Settings.b2_linearSlop ? this.m_u1.Multiply(1 / d) : this.m_u1.SetZero();
        m > b2Settings.b2_linearSlop ? this.m_u2.Multiply(1 / m) : this.m_u2.SetZero();
        d = this.m_constant - d - this.m_ratio * m;
        q = b2Math.b2Max(q, -d);
        d = b2Math.b2Clamp(d + b2Settings.b2_linearSlop, -b2Settings.b2_maxLinearCorrection, 0);
        d = -this.m_pulleyMass * d;
        m = this.m_positionImpulse;
        this.m_positionImpulse = b2Math.b2Max(0, this.m_positionImpulse + d);
    ...
    if (this.m_limitState1 == b2Joint.e_atUpperLimit) {
        ...
        this.m_limitPositionImpulse1 = b2Math.b2Max(0, this.m_limitPositionImpulse1 + d);
    ...
    if (this.m_limitState2 == b2Joint.e_atUpperLimit) {
        ...
        this.m_limitPositionImpulse2 = b2Math.b2Max(0, this.m_limitPositionImpulse2 + d);
        d = this.m_limitPositionImpulse2 - e;
        o = -d * this.m_u2.x;
        d = -d * this.m_u2.y;
        c.m_sweep.c.x += c.m_invMass * o;
        c.m_sweep.c.y += c.m_invMass * d;
    ...
    return q < b2Settings.b2_linearSlop
};
...
b2RevoluteJoint.prototype.__constructor = function(b) {
    this._super(b);
    this.m_localAnchor1.SetV(b.localAnchor1);
    this.m_localAnchor2.SetV(b.localAnchor2);
...
a.m_localAnchor1 = new b2Vec2;
a.m_localAnchor2 = new b2Vec2;
a.m_pivotForce = new b2Vec2;
a.m_motorForce = null;
a.m_limitForce = null;
a.m_limitPositionImpulse = null;
a.m_pivotMass = new b2Mat22;
a.m_motorMass = null;
...
a.InitVelocityConstraints = function(b) {
    ...
    if (this.m_enableLimit) {
        ...
        if (b2Math.b2Abs(this.m_upperAngle - this.m_lowerAngle) < 2 * b2Settings.b2_angularSlop) this.m_limitState = b2Joint.e_equalLimits;
            ...
            if (this.m_limitState != b2Joint.e_atLowerLimit) this.m_limitForce = 0;
            this.m_limitState = b2Joint.e_atLowerLimit
        }
        else if (m >= this.m_upperAngle) {
            if (this.m_limitState != b2Joint.e_atUpperLimit) this.m_limitForce = 0;
...
a.SolveVelocityConstraints = function(b) {
    ...
    var k = d.m_linearVelocity.y + d.m_angularVelocity * i - c.m_linearVelocity.y - c.m_angularVelocity * g;
    ...
    if (this.m_enableMotor && this.m_limitState != b2Joint.e_equalLimits) {
        ...
        h = this.m_motorForce;
        this.m_motorForce = b2Math.b2Clamp(this.m_motorForce + g, -this.m_maxMotorTorque, this.m_maxMotorTorque);
    ...
    if (this.m_enableLimit && this.m_limitState != b2Joint.e_inactiveLimit) {
        ...
        if (this.m_limitState == b2Joint.e_equalLimits) this.m_limitForce += h;
        else if (this.m_limitState == b2Joint.e_atLowerLimit) {
            g = this.m_limitForce;
            this.m_limitForce = b2Math.b2Max(this.m_limitForce + h, 0);
            h = this.m_limitForce - g
        }
        else if (this.m_limitState == b2Joint.e_atUpperLimit) {
            g = this.m_limitForce;
            this.m_limitForce = b2Math.b2Min(this.m_limitForce + h, 0);
            h = this.m_limitForce - g
        }
...
a.SolvePositionConstraints = function() {
    ...
    this.K.AddM(this.K2);
    this.K.AddM(this.K3);
    this.K.Solve(b2RevoluteJoint.tImpulse, -h, -j);
    h = b2RevoluteJoint.tImpulse.x;
    ...
    if (this.m_enableLimit && this.m_limitState != b2Joint.e_inactiveLimit) {
        ...
        if (this.m_limitState == b2Joint.e_equalLimits) {
            ...
            this.m_limitPositionImpulse = b2Math.b2Max(this.m_limitPositionImpulse + g, 0);
            ...
            g = -this.m_motorMass * b;
            b = this.m_limitPositionImpulse;
            this.m_limitPositionImpulse = b2Math.b2Min(this.m_limitPositionImpulse + g, 0);
            g = this.m_limitPositionImpulse - b
        }
...
a.m_localAnchor1 = new b2Vec2;
a.m_localAnchor2 = new b2Vec2;
a.m_localXAxis1 = new b2Vec2;
a.m_localYAxis1 = new b2Vec2;
a.m_refAngle = null;
a.m_linearJacobian = new b2Jacobian;
a.m_linearMass = null;
a.m_force = null;
a.m_angularMass = null;
a.m_torque = null;
a.m_motorJacobian = new b2Jacobian;
a.m_motorMass = null;
a.m_motorForce = null;
a.m_limitForce = null;
a.m_limitPositionImpulse = null;
...
a.GetReactionForce = function() {
    ...
    return new b2Vec2(this.m_limitForce * this.m_limitForce * (b.col1.x * this.m_localXAxis1.x + b.col2.x * this.m_localXAxis1.y) + this.m_force * this.m_force * (b.col1.x * this.m_localYAxis1.x + b.col2.x * this.m_localYAxis1.y), this.m_limitForce * this.m_limitForce * (b.col1.y * this.m_localXAxis1.x + b.col2.y * this.m_localXAxis1.y) + this.m_force * this.m_force * (b.col1.y * this.m_localYAxis1.x + b.col2.y * this.m_localYAxis1.y))
};
a.GetReactionTorque = function() {
...
a.InitVelocityConstraints = function(b) {
    ...
    var k = d.m_invMass,
        ...
        m = d.m_invI;
    e = c.m_xf.R;
    var n = e.col1.x * this.m_localYAxis1.x + e.col2.x * this.m_localYAxis1.y;
    e = e.col1.y * this.m_localYAxis1.x + e.col2.y * this.m_localYAxis1.y;
    var o = d.m_sweep.c.x + i - c.m_sweep.c.x,
        q = d.m_sweep.c.y + j - c.m_sweep.c.y;
    ...
    if (this.m_enableLimit || this.m_enableMotor) {
        ...
        if (this.m_enableLimit) {
            g = n * (o - g) + e * (q - h);
            if (b2Math.b2Abs(this.m_upperTranslation - this.m_lowerTranslation) < 2 * b2Settings.b2_linearSlop) this.m_limitState = b2Joint.e_equalLimits;
    ...
    if (b.warmStarting) {
        ...
        h = b.dt * (this.m_force * this.m_linearJacobian.linear2.x + (this.m_motorForce + this.m_limitForce) * this.m_motorJacobian.linear2.x);
        ...
        c.m_linearVelocity.x += f * b.dt * (this.m_force * this.m_linearJacobian.linear1.x + (this.m_motorForce + this.m_limitForce) * this.m_motorJacobian.linear1.x);
...
a.SolveVelocityConstraints = function(b) {
    ...
    if (this.m_enableMotor && this.m_limitState != b2Joint.e_equalLimits) {
        ...
        this.m_motorForce = b2Math.b2Clamp(this.m_motorForce + i, -this.m_maxMotorForce, this.m_maxMotorForce);
    ...
    if (this.m_enableLimit && this.m_limitState != b2Joint.e_inactiveLimit) {
        ...
        if (this.m_limitState == b2Joint.e_equalLimits) this.m_limitForce += j;
        else if (this.m_limitState == b2Joint.e_atLowerLimit) {
            i = this.m_limitForce;
            this.m_limitForce = b2Math.b2Max(this.m_limitForce + j, 0);
            j = this.m_limitForce - i
        }
        else if (this.m_limitState == b2Joint.e_atUpperLimit) {
            i = this.m_limitForce;
            this.m_limitForce = b2Math.b2Min(this.m_limitForce + j, 0);
            j = this.m_limitForce - i
        }
        i = b.dt * j;
        c.m_linearVelocity.x += e * i * this.m_motorJacobian.linear1.x;
...
a.SolvePositionConstraints = function() {
    ...
    if (this.m_enableLimit && this.m_limitState != b2Joint.e_inactiveLimit) {
        ...
        b = 0;
        if (this.m_limitState == b2Joint.e_equalLimits) {
            b = b2Math.b2Clamp(j, -b2Settings.b2_maxLinearCorrection, b2Settings.b2_maxLinearCorrection);
            b = -this.m_motorMass * b;
            o = b2Math.b2Max(o, b2Math.b2Abs(c))
        }
        else if (this.m_limitState == b2Joint.e_atLowerLimit) {
            b = j - this.m_lowerTranslation;
            o = b2Math.b2Max(o, -b);
            b = b2Math.b2Clamp(b + b2Settings.b2_linearSlop, -b2Settings.b2_maxLinearCorrection, 0);
            b = -this.m_motorMass * b;
            c = this.m_limitPositionImpulse;
            this.m_limitPositionImpulse = b2Math.b2Max(this.m_limitPositionImpulse + b, 0);
            b = this.m_limitPositionImpulse - c
        }
        else if (this.m_limitState == b2Joint.e_atUpperLimit) {
            b = j - this.m_upperTranslation;
            o = b2Math.b2Max(o, b);
            b = b2Math.b2Clamp(b - b2Settings.b2_linearSlop, 0, b2Settings.b2_maxLinearCorrection);
            b = -this.m_motorMass * b;
            c = this.m_limitPositionImpulse;
            this.m_limitPositionImpulse = b2Math.b2Min(this.m_limitPositionImpulse + b, 0);
            b = this.m_limitPositionImpulse - c
        }
    ...
    return o <= b2Settings.b2_linearSlop && q <= b2Settings.b2_angularSlop
};
...
b2PolyAndCircleContact.prototype.__constructor = function(b, c) {
    this._super(b, c);
    this.m_manifold = this.m_manifolds[0];
...
b2PolyAndCircleContact.Create = function(b, c) {
    return new b2PolyAndCircleContact(b, c)
};
b2PolyAndCircleContact.Destroy = function() {};
a = b2PolyAndCircleContact.prototype;
a.m_manifolds = [new b2Manifold];
a.m0 = new b2Manifold;
a.m_manifold = null;
a.Evaluate = function(b) {
    var c = 0,
        d, e, f, g = this.m_shape1.m_body,
        h = this.m_shape2.m_body;
    this.m0.Set(this.m_manifold);
    b2Collision.b2CollidePolygonAndCircle(this.m_manifold, this.m_shape1, g.m_xf, this.m_shape2, h.m_xf);
    var i = [false, false],
        j = b2PolyAndCircleContact.s_evalCP;
...
b2ContactManager.prototype._super = function() {
    b2PairCallback.prototype.__constructor.apply(this, arguments)
};
...
a = b2ContactManager.prototype;
a.m_world = null;
a.m_nullContact = new b2NullContact;
...
a.PairAdded = function(b, c) {
    ...
    var f = b2Contact.Create(b, c, this.m_world.m_blockAllocator);
...
a.Destroy = function(b) {
    ...
    if (e > 0 && this.m_world.m_contactListener) {
        ...
        for (var j = 0; j < e; ++j) {
            ...
            for (var l = 0; l < k.pointCount; ++l) {
                ...
                var n = f.GetLinearVelocityFromLocalPoint(m.localPoint1),
                    o = g.GetLinearVelocityFromLocalPoint(m.localPoint2);
    ...
    b2Contact.Destroy(b, this.m_world.m_blockAllocator);
    --this.m_world.m_contactCount
};
a.Collide = function() {
...
b2World.prototype.__constructor = function(b, c, d) {
    ...
    this.m_broadPhase = new b2BroadPhase(b, this.m_contactManager);
...
a.m_raycastNormal = new b2Vec2;
a.m_blockAllocator = null;
a.m_stackAllocator = null;
a.m_lock = null;
a.m_broadPhase = null;
a.m_contactManager = new b2ContactManager;
a.m_bodyList = null;
a.m_jointList = null;
a.m_contactList = null;
a.m_bodyCount = 0;
...
a.DestroyBody = function(b) {
    if (this.m_lock != true) {
        ...
        for (c = b.m_shapeList; c;) {
            ...
            b2Shape.Destroy(d, this.m_blockAllocator)
        }
        if (b.m_prev) b.m_prev.m_next = b.m_next;
        if (b.m_next) b.m_next.m_prev = b.m_prev;
...
a.CreateJoint = function(b) {
    var c = b2Joint.Create(b, this.m_blockAllocator);
    c.m_prev = null;
...
a.DestroyJoint = function(b) {
    ...
    b.m_node2.prev = null;
    b.m_node2.next = null;
    b2Joint.Destroy(b, this.m_blockAllocator);
    --this.m_jointCount;
    if (c == false) {
...
a.SetWarmStarting = function(b) {
    b2World.m_warmStarting = b
};
a.SetPositionCorrection = function(b) {
    b2World.m_positionCorrection = b
};
a.SetContinuousPhysics = function(b) {
    b2World.m_continuousPhysics = b
};
...
a.Step = function(b, c) {
    this.m_lock = true;
    var d = new b2TimeStep;
    d.dt = b;
    d.maxIterations = c;
    d.inv_dt = b > 0 ? 1 / b : 0;
    d.dtRatio = this.m_inv_dt0 * b;
    d.positionCorrection = b2World.m_positionCorrection;
    d.warmStarting = b2World.m_warmStarting;
    this.m_contactManager.Collide();
    d.dt > 0 && this.Solve(d);
    b2World.m_continuousPhysics && d.dt > 0 && this.SolveTOI(d);
    this.DrawDebugData();
...
a.Solve = function(b) {
    var c;
    this.m_positionIterationCount = 0;
    var d = new b2Island(this.m_bodyCount, this.m_contactCount, this.m_jointCount, this.m_stackAllocator, this.m_contactListener);
    for (c = this.m_bodyList; c; c = c.m_next) c.m_flags &= ~b2Body.e_islandFlag;
    for (var e = this.m_contactList; e; e = e.m_next) e.m_flags &= ~b2Contact.e_islandFlag;
    for (e = this.m_jointList; e; e = e.m_next) e.m_islandFlag = false;
    e = new Array(this.m_bodyCount);
    for (var f = this.m_bodyList; f; f = f.m_next) if (!(f.m_flags & (b2Body.e_islandFlag | b2Body.e_sleepFlag | b2Body.e_frozenFlag))) if (!f.IsStatic()) {
        d.Clear();
        var g = 0;
        e[g++] = f;
        for (f.m_flags |= b2Body.e_islandFlag; g > 0;) {
            c = e[--g];
            d.AddBody(c);
            c.m_flags &= ~b2Body.e_sleepFlag;
            if (!c.IsStatic()) {
                for (var h, i = c.m_contactList; i; i = i.next) if (!(i.contact.m_flags & (b2Contact.e_islandFlag | b2Contact.e_nonSolidFlag))) if (i.contact.m_manifoldCount != 0) {
                    d.AddContact(i.contact);
                    i.contact.m_flags |= b2Contact.e_islandFlag;
                    h = i.other;
                    if (!(h.m_flags & b2Body.e_islandFlag)) {
                        e[g++] = h;
                        h.m_flags |= b2Body.e_islandFlag
                    }
                }
        ...
        d.Solve(b, this.m_gravity, b2World.m_positionCorrection, this.m_allowSleep);
        ...
        for (g = 0; g < d.m_bodyCount; ++g) {
            c = d.m_bodies[g];
            if (c.IsStatic()) c.m_flags &= ~b2Body.e_islandFlag
        }
    }
    for (c = this.m_bodyList; c; c = c.m_next) c.m_flags & (b2Body.e_sleepFlag | b2Body.e_frozenFlag) || c.IsStatic() || c.SynchronizeShapes() == false && this.m_boundaryListener != null && this.m_boundaryListener.Violation(c);
    this.m_broadPhase.Commit()
};
a.SolveTOI = function(b) {
    var c, d, e, f = new b2Island(this.m_bodyCount, b2Settings.b2_maxTOIContactsPerIsland, 0, this.m_stackAllocator, this.m_contactListener),
    ...
    var h;
    for (h = this.m_contactList; h; h = h.m_next) h.m_flags &= ~ (b2Contact.e_toiFlag | b2Contact.e_islandFlag);
    for (;;) {
        c = null;
        var i = 1;
        for (h = this.m_contactList; h; h = h.m_next) if (!(h.m_flags & (b2Contact.e_slowFlag | b2Contact.e_nonSolidFlag))) {
            d = 1;
            if (h.m_flags & b2Contact.e_toiFlag) d = h.m_toi;
            else {
                d = h.m_shape1;
                e = h.m_shape2;
                d = d.m_body;
                ...
                d = b2TimeOfImpact.TimeOfImpact(h.m_shape1, d.m_sweep, h.m_shape2, e.m_sweep);
                if (d > 0 && d < 1) {
                    d = (1 - d) * j + d;
                    if (d > 1) d = 1
                }
                h.m_toi = d;
                h.m_flags |= b2Contact.e_toiFlag
            }
        ...
        if (c.m_manifoldCount != 0) {
            ...
            h = 0;
            g[h++] = c;
            for (c.m_flags |= b2Body.e_islandFlag; h > 0;) {
                c = g[--h];
                f.AddBody(c);
                c.m_flags &= ~b2Body.e_sleepFlag;
                if (!c.IsStatic()) for (c = c.m_contactList; c; c = c.next) if (f.m_contactCount != f.m_contactCapacity) if (!(c.contact.m_flags & (b2Contact.e_islandFlag | b2Contact.e_slowFlag | b2Contact.e_nonSolidFlag))) if (c.contact.m_manifoldCount != 0) {
                    f.AddContact(c.contact);
                    c.contact.m_flags |= b2Contact.e_islandFlag;
                    d = c.other;
            ...
            for (i = i = 0; i < f.m_bodyCount; ++i) {
                c = f.m_bodies[i];
                c.m_flags &= ~b2Body.e_islandFlag;
                if (!(c.m_flags & (b2Body.e_sleepFlag | b2Body.e_frozenFlag))) if (!c.IsStatic()) {
                    c.SynchronizeShapes() == false && this.m_boundaryListener != null && this.m_boundaryListener.Violation(c);
                    for (c = c.m_contactList; c; c = c.next) c.contact.m_flags &= ~b2Contact.e_toiFlag
                }
            }
            for (i = 0; i < f.m_contactCount; ++i) {
                h = f.m_contacts[i];
                h.m_flags &= ~ (b2Contact.e_toiFlag | b2Contact.e_islandFlag)
            }
            this.m_broadPhase.Commit()
        }
    }
...
a.DrawShape = function(b, c, d, e) {
    var f = b2World.s_coreColor;
    switch (b.m_type) {
    case b2Shape.e_circleShape:
        var g = b2Math.b2MulX(c, b.m_localPosition);
        b = b.m_radius;
        this.m_debugDraw.DrawSolidCircle(g, b, c.R.col1, d);
        e && this.m_debugDraw.DrawCircle(g, b - b2Settings.b2_toiSlop, f);
        break;
    case b2Shape.e_polygonShape:
        g = 0;
        var h = b.GetVertexCount(),
            i = b.GetVertices(),
            j = new Array(b2Settings.b2_maxPolygonVertices);
        for (g = 0; g < h; ++g) j[g] = b2Math.b2MulX(c, i[g]);
        this.m_debugDraw.DrawSolidPolygon(j, h, d);
        if (e) {
            d = b.GetCoreVertices();
            for (g = 0; g < h; ++g) j[g] = b2Math.b2MulX(c, d[g]);
...
a.DrawDebugData = function() {
    if (this.m_debugDraw != null) {
        ...
        var b = this.m_debugDraw.GetFlags(),
            ...
            j, k = new b2AABB,
            l = new b2AABB,
            m = [new b2Vec2, new b2Vec2, new b2Vec2, new b2Vec2];
        if (b & b2DebugDraw.e_shapeBit) {
            c = (b & b2DebugDraw.e_coreShapeBit) == b2DebugDraw.e_coreShapeBit;
            for (d = this.m_bodyList; d; d = d.m_next) {
                j = d.m_xf;
                for (e = d.GetShapeList(); e; e = e.m_next) if (d.IsStatic()) this.DrawShape(e, j, new b2Color(0.5, 0.9, 0.5), c);
                else d.IsSleeping() ? this.DrawShape(e, j, new b2Color(0.5, 0.5, 0.9), c) : this.DrawShape(e, j, new b2Color(0.9, 0.9, 0.9), c)
            }
        }
        if (b & b2DebugDraw.e_jointBit) for (c = this.m_jointList; c; c = c.m_next) this.DrawJoint(c);
        if (b & b2DebugDraw.e_pairBit) {
            d = this.m_broadPhase;
            f.Set(1 / d.m_quantizationFactor.x, 1 / d.m_quantizationFactor.y);
            i.Set(0.9, 0.9, 0.3);
            for (c = 0; c < b2Pair.b2_tableCapacity; ++c) for (e = d.m_pairManager.m_hashTable[c]; e != b2Pair.b2_nullPair;) {
        ...
        if (b & b2DebugDraw.e_aabbBit) {
            ...
            m[2].Set(h.x, h.y);
            m[3].Set(g.x, h.y);
            this.m_debugDraw.DrawPolygon(m, 4, new b2Color(0.3, 0.9, 0.9))
        }
        if (b & b2DebugDraw.e_obbBit) {
            i.Set(0.5, 0.3, 0.5);
            for (d = this.m_bodyList; d; d = d.m_next) {
                j = d.m_xf;
                for (e = d.GetShapeList(); e; e = e.m_next) if (e.m_type == b2Shape.e_polygonShape) {
                    f = e.GetOBB();
                    c = f.extents;
                    m[0].Set(-c.x, -c.y);
                    m[1].Set(c.x, -c.y);
        ...
        if (b & b2DebugDraw.e_centerOfMassBit) for (d = this.m_bodyList; d; d = d.m_next) {
            j = b2World.s_xf;
            j.R = d.m_xf.R;
...
a.RaycastSortKey = function(b) {
    ...
    var c = b.GetBody().GetXForm(),
        d = [0];
    if (b.TestSegment(c, d, this.m_raycastNormal, this.m_raycastSegment, 1) == b2Shape.e_missCollide) return -1;
    return d[0]
};
a.RaycastSortKey2 = function(b) {
    ...
    var c = b.GetBody().GetXForm(),
        d = [0];
    if (b.TestSegment(c, d, this.m_raycastNormal, this.m_raycastSegment, 1) != b2Shape.e_hitCollide) return -1;
    return d[0]
};		